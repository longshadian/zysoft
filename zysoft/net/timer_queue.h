#ifndef _ZYSOFT_NET_TIMER_QUEUE_H
#define _ZYSOFT_NET_TIMER_QUEUE_H
...
private:
    ...
    void reg_timer()
    {
        timer_->expires_after(std::chrono::milliseconds((1000/tick_HZ)));
...
#endif // !_ZYSOFT_NET_TIMER_QUEUE_H
